...
function Edit({
  ...
  const allowedBlocks = ["core/heading", "ttm/columns", "ttm/input-date", "ttm/input-email", "ttm/input-hidden", "ttm/input-password", "ttm/input-submit", "ttm/input-tel", "ttm/input-text", "ttm/textarea"];
  const {
    to,
    subject
  } = attributes;
